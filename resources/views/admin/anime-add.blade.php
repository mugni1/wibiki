<x-admin-layout>
    ...
    <section class=" px-5 w-full mx-auto pb-5 mt-28 md:mt-5">
        <h1 class=" text-center font-bold text-xl pb-5">Add New anime</h1>

        {{-- card form --}}
        <div class=" md:w-1/2 w-full container mx-auto ">
            <form action="/dashboard/anime-add/store" method="POST" enctype="multipart/form-data" class=" w-full flex flex-wrap">
                @csrf
                ...
                <div class=" w-full flex flex-wrap py-2">
                    ...
                    <input required type="text" name="studio" id="studio" class="py-1 px-2 shadow-md w-full rounded-md border outline-none" placeholder="Masukan di sini">
                </div>
                <div class=" w-full flex flex-wrap py-2">
                    <label for="producer" class="font-semibold w-full">Masukan Nama producer</label>
                    <input required type="text" name="producer" id="producer" class="py-1 px-2 shadow-md w-full rounded-md border outline-none" placeholder="Masukan di sini">
                </div>
                <div class=" w-full flex flex-wrap py-2">
                    <label for="status" class="font-semibold w-full">Pilih status anime</label>
                    <div class=" flex items-center">
                        <div class="me-10 flex">
                            <input required class="me-1" type="radio" name="status" id="ongoing" value="Ongoing">
                            <label for="ongoing">Ongoing</label>
                        </div>
                        <div class=" me-10 flex">
                            <input required class="me-1" type="radio" name="status" id="completed" value="Completed">
